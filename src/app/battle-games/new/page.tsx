...
export default function NewBattleGamePage() {
  ...
  return (
    <main className="p-10 text-white max-w-lg space-y-6">
      ...
      <h1 className="text-2xl font-bold">Create battlegame</h1>
      <form onSubmit={submit} className="space-y-4">
        ...
        <div>
          ...
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" value={lives} onChange={(e) => setLives(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Respawn</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" value={respawn} onChange={(e) => setRespawn(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Base</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" value={base} onChange={(e) => setBase(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Teams</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" value={teams} onChange={(e) => setTeams(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Min players</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" inputMode="numeric" value={minPlayers} onChange={(e) => setMinPlayers(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Max players</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" inputMode="numeric" value={maxPlayers} onChange={(e) => setMaxPlayers(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Min teams</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" inputMode="numeric" value={minTeams} onChange={(e) => setMinTeams(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Max teams</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" inputMode="numeric" value={maxTeams} onChange={(e) => setMaxTeams(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Objectives</label>
          <textarea className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded min-h-20" value={objectives} onChange={(e) => setObjectives(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Refresh</label>
          <input className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded" value={refresh} onChange={(e) => setRefresh(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm text-neutral-400 mb-1">Scenario Rules</label>
          <textarea className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded min-h-20" value={scenarioRules} onChange={(e) => setScenarioRules(e.target.value)} />
        </div>
        <div>
