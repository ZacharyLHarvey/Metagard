  ...
  return (
    <main className="p-10 text-white space-y-6">
      <div className="flex flex-wrap gap-4 items-baseline justify-between">
        <h1 className="text-2xl font-bold">Custom Class Leaderboard</h1>
        <Link href="/leaderboards" className="text-sm text-blue-400 hover:underline">
          ← Main Leaderboards
        </Link>
      </div>
      <p className="text-sm text-neutral-400 max-w-2xl">
        Ranked by average custom class rating, then vote count. Rate custom classes from the{" "}
        <Link href="/custom-classes" className="text-blue-400 underline">
          Custom Classes page
        </Link>
        .
      </p>
