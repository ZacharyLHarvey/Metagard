...
export default function BuildSideboardSection({ spells, spellbookTipsEnabled }: Props) {
  return (
    <section className="rounded-lg border border-neutral-800 overflow-hidden">
      ...
      <SideboardSpellList spells={spells} spellbookTipsEnabled={spellbookTipsEnabled} />
    </section>
  );
}
